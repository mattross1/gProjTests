...
public class SupportSuccess {
  ...
  @Test
  public void testSupportSuccess() throws Exception {
    driver.get("http://iceteam.ddns.net/");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Remove'])[1]/following::span[3]")).click();
    Thread.sleep(1000);
  }
  ...
  public void tearDown() throws Exception {
	  LogEntries entry = driver.manage().logs().get(LogType.BROWSER);
		...
		int found = 0;
		for (LogEntry l : logs) {
			if (String.valueOf(l).indexOf("success.support") != -1) {
				found = 1;
			}
		}
	driver.quit();
