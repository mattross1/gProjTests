...
public class SignupFail {
  ...
  public void testSignupFail() throws Exception {
    ...
    driver.findElement(By.name("firstHTML")).sendKeys("LETTERSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS");
    driver.findElement(By.name("lastHTML")).click();
    driver.findElement(By.name("lastHTML")).clear();
    driver.findElement(By.name("lastHTML")).sendKeys("Letter");
    driver.findElement(By.name("emailHTML")).click();
    driver.findElement(By.name("emailHTML")).clear();
    driver.findElement(By.name("emailHTML")).sendKeys("letter@email.com");
    driver.findElement(By.name("phoneHTML")).click();
    driver.findElement(By.name("phoneHTML")).clear();
    driver.findElement(By.name("phoneHTML")).sendKeys("402-888-8888");
  ...
  public void tearDown() throws Exception {
	  LogEntries entry = driver.manage().logs().get(LogType.BROWSER);
		...
		int found = 0;
		for (LogEntry l : logs) {
			if (String.valueOf(l).indexOf("fail.signup") != -1) {
				found = 1;
			}
		}
	driver.quit();
